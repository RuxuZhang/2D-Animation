...
PNT Neville(float a, PNT A, float b, PNT B, float t) 
  ...
  return LERP(A,(t-a)/(b-a),B); // correct
  }
...
PNT Neville(float a, PNT A, float b, PNT B, float c, PNT C, float t) 
  ...
  PNT S = Neville(a,A,b,B,t), E = Neville(b,B,c,C,t);
  return Neville(a,S,c,E,t); // correct
  }
...
PNT Neville(float a, PNT A, float b, PNT B, float c, PNT C, float d, PNT D, float t) 
  ...
  PNT S = Neville(a,A,b,B,c,C,t), E = Neville(b,B,c,C,d,D,t);
  return Neville(a,S,d,E,t);
  }

//**** By Ruxu Zhang ****

PNT NevilleSmooth(float a, PNT Pt1, float b, PNT Pt2, float c, PNT Pt3, float d, float t)  {
  return Neville(a,Neville(a,Pt1,c,Pt2,t),d,Neville(b,Pt2,d,Pt3,t),t);
}
